...
<body>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="ketbwmk" id="ketbwmk" class="form-control"
                                                        value="<?php echo !empty($data['ketbwmk']) ? $data['ketbwmk'] : '-'; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function terbilangProvisi(number) {
            let angka = ['Nol', 'Satu', 'Dua', 'Tiga', 'Empat', 'Lima', 'Enam', 'Tujuh', 'Delapan', 'Sembilan', 'Sepuluh'];
            let terbilang = '';
