...
try {
    ...
    <table class="no-border" style="margin-left: 0px;">
        ...
        <tr>
            ...
            <td>:</td>
            <td>0% /Bulan dari total angsuran yang tertunggak</td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            <td></td>
            <td colspan="3">i. Pelunasan Kredit sebelum melampaui 50 % dari jadwal angsuran yang seharusnya, dikenakan bunga sebesar 50% dari total kewajiban bunga sampai jatuh tempo kredit.</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="3">ii. Pelunasan Kredit setelah melampaui 50% dari jadwal angsuran yang seharusnya, dan belum jatuh tempo tanggal valuta dikenakan bunga berjalan ditambah bunga 3 (Tiga) bulan ke depan.</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="3">iii. Pelunasan Kredit setelah melampaui 50% dari jadwal angsuran yang seharusnya, dan sudah jatuh tempo tanggal valuta dikenakan bunga berjalan ditambah 4 (Empat) bulan ke depan.</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="3">iv. Pelunasan Kredit dengan sisa kewajiban bunga =< 3 (Tiga) bulan, maka bunga pelunasan dibayar maksimal sampai dengan sisa kewajiban bunga.</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="3">v. Untuk Pelunasan Kredit jika ada tunggakan angsuran bunga, maka pelunasannya adalah jumlah bunga tertunggak ditambah pelunasan bunga yang tercantum dalam point i,ii,iii, dan iv</td>
        </tr>
        <tr>
            <td></td>
    ...
    $filename = 'SMTPK HAJI - ' . $data['nama'] . ' ' . formatTanggalIndonesia($data['tgl_droping']) . '.pdf';

    // Tulis HTML ke PDF
    $mpdf->SetTitle('SMTPK HAJI - ' . $data['nama'] . ' ' . formatTanggalIndonesia($data['tgl_droping']));
    $mpdf->WriteHTML($html);
