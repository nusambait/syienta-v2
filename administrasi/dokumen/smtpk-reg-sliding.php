...
try {
    ...
    <table class="no-border" style="margin-left: 0px;">
        ...
        <tr>
            <td></td>
            <td colspan="3">i. Pelunasan dilakukan sebelum tanggal valuta, maka dikenakan kewajiban sampai dengan bulan pelunasan</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="3">ii. Pelunasan dilakukan setelah tanggal valuta, maka dikenakan bunga kewajiban sampai dengan bulan pelunasan dan ditambah bunga kewajiban selisih dari tanggal valuta sampai dengan tanggal penulasan secara porposional.</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="3">iii. Pelunasan kredit jika terdapat adanya denda keterlambatan, maka perhitungannya : pokok di tambah bunga kewajiban ditambah dengan denda. Besaran denda sebagai berikut :</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="3">iv. Denda dihitung sebesar 2,5% per bulan untuk pinjaman yang melakukan pelunasan setelah habis jangka waktu perjanjian kredit.</td>
        </tr>
        <tr>
            <td></td>
    ...
    $filename = 'SMTPK REG SLIDING - ' . $data['nama'] . ' ' . formatTanggalIndonesia($data['tgl_droping']) . '.pdf';

    // Tulis HTML ke PDF
    $mpdf->SetTitle('SMTPK REG SLIDING - ' . $data['nama'] . ' ' . formatTanggalIndonesia($data['tgl_droping']));
    $mpdf->WriteHTML($html);
