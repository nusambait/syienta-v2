...
try {
    ...
    <div style="margin-bottom: -10px;">
        ...
        <p><strong><u>Perihal : Lampiran Asuransi Personal Accident Plus (Paket A2)</strong></u></p>
    </div>
    
    <div>
        <p><strong>A. Jenis Paket Asuransi Personal Accident Plus :</strong></p>
        <ol>
            <li>Paket A2 adalah paket yang menjamin dari sisa kredit pinjaman yang disetujui oleh Bank kepada debitur pada saat akad kredit.</li>
        </ol>
        ...
        <ol>
            <li>Paket A2 (Menurun)</li>
        </ol>
        
        <p>Nilai pertanggungan Asuransi personal accident Plus :<br>
        - Usia 18 Tahun s/d 45 Tahun : Rp. 400.000.000,-<br>
        - Usia 18 Tahun s/d 55 Tahun : Rp. 300.000.000,-<br>
        - Usia 18 Tahun s/d 65 Tahun : Rp. 250.000.000,-</p>
    ...
    $filename = 'Lampiran Asuransi Personal Accident Plus (Paket A2) - ' . $data['nama'] . ' ' . $tanggal_dropping . '.pdf';

    // Tulis HTML ke PDF
    $mpdf->SetTitle('Lampiran Asuransi Personal Accident Plus (Paket A2) - ' . $data['nama'] . ' ' . $tanggal_dropping);
    $mpdf->WriteHTML($html);
