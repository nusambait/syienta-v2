...
<body>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <label for="ket_peng" class="form-label mb-0">Keterangan Pengajuan</label>
                                                <button type="button" id="btn-ai-generate" class="btn-ai-gen d-flex align-items-center gap-1" onclick="generateAIDescription()" title="Generate AI Description">
                                                    <span style="font-size: 0.85em; font-weight: 500; color: #0d6efd;">Gunakan AI nusamba-o1</span>
                                                    <img src="../assets/media/btn-ai.png" alt="AI" style="width:25px;height:25px;object-fit:contain;display:block;">
                                                </button>
                                            </div>
                                            <div style="position:relative;">
                                                <textarea class="form-control" id="ket_peng" name="ket_peng" rows="4" style="padding-right:8px;"></textarea>
                                                <span id="ai-loading" class="ms-2 text-primary small d-none" style="position:absolute;top:50%;right:8px;transform:translateY(-50%);z-index:2;white-space:nowrap;">Sedang menggenerate dengan ai nusamba-o1...</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        // Fungsi untuk generate keterangan pengajuan dengan AI
        function generateAIDescription() {
            ...
            // Ambil data dari form yang sudah diisi
            const nama = document.getElementById('nama').value || 'Nasabah';
            const jenisKredit = document.getElementById('jns_kredit').value || 'Kredit';
            const jumlah = document.getElementById('jumlahPengajuan').value || '0';
            const jw = document.getElementById('jw').value || '12';
            const sukbung = document.getElementById('sukbung').value || '0';
            const penggunaan = document.getElementById('penggunaan').value || 'Konsumtif';
            const prodkre = document.getElementById('prodkre').value || 'Produk Kredit';

            // Array template keterangan yang berbeda
            const templates = [
                `Pengajuan ${jenisKredit} untuk ${nama} dengan plafon Rp ${jumlah} untuk jangka waktu ${jw} bulan dengan suku bunga ${sukbung}% per tahun. Produk: ${prodkre}, penggunaan: ${penggunaan}.`,
                `${nama} mengajukan ${jenisKredit} sebesar Rp ${jumlah} dengan tenor ${jw} bulan. Suku bunga ${sukbung}% per tahun. Produk ${prodkre} untuk ${penggunaan}.`,
                `Permohonan ${jenisKredit} oleh ${nama} dengan nominal Rp ${jumlah}, jangka waktu ${jw} bulan, bunga ${sukbung}% per tahun. Produk: ${prodkre}, tujuan: ${penggunaan}.`,
                `Kredit ${jenisKredit} untuk ${nama} sebesar Rp ${jumlah} dengan masa ${jw} bulan. Bunga ${sukbung}% per tahun. Produk ${prodkre} untuk ${penggunaan}.`,
                `Pengajuan ${jenisKredit} ${nama} Rp ${jumlah} untuk ${jw} bulan. Suku bunga ${sukbung}% per tahun. Produk: ${prodkre}, penggunaan: ${penggunaan}.`
            ];
            ...
            // Simulasikan proses AI (delay 1.5 detik)
            setTimeout(function() {
                document.getElementById('ket_peng').value = selectedTemplate;
                btn.disabled = false;
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'AI Generated!',
                    text: 'Keterangan pengajuan telah diisi otomatis',
                    timer: 1500,
                    showConfirmButton: false
                });
            }, 1500);
